 ...
 class AVLTree
 {
     ...
     public AVLNode insertNode(int target, AVLNode root)
     {
      ...
      // if after the insertion, the tree becomes unbalanced
             if( balance == -2 )  
      // if x inserted into the left-left subtree, balancing a left-left tree
                 if( target < root.l_child.value )                        
                     root = rotateRight( root );    
                 else
      // if x inserted into the left-right subtree, rotate left then rotate right
         ...
         else if( target > root.value )                 
         {
          ...
          // if after the insertion, the tree becomes unbalanced
             if( balance == 2 )   
            	...
            	// if x inserted into the right-right subtree, balancing a right-right tree
                 if( target > root.r_child.value)
                     root = rotateLeft( root );  
             // if x inserted into the right-left subtree, rotate right then rotate left
                 else
